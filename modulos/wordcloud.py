...
def crear_wordcloud(df, cols_cita):
    ...
    stopwords_personalizadas = {
        ...
        "que", "e1", "f2", "f3", "como", "se", "los", "mas", "más","esta", "están", "están", "están", "están", "están", "están", "están","porque", "cómo", "cuál", "cuáles", "quién", "quiénes", "dónde", "cuándo", "por qué","vez", "puede", "pueden", "debe", "deben","ser", "estar", "tener", "hacer", "decir", "ir", "ver", "dar", "saber", "querer", "llegar",
        "sd2", "sd1", "es", "su", "ejemplo", "f2_sd1", "f2_sd2","fuente", "f1_sd1", "f1_sd2", "f1_sd3", "f3_sd1", "f3_sd2","documento", "f3_sd3", "e04_sd1", "e04_sd2", "e04_sd3", "e04_sd4","tema", "temas", "aspecto", "aspectos", "punto", "puntos","ser", "estar", "tener", "hacer", "decir", "ir", "ver", "dar", "saber", "querer", "llegar",
        "f2_sd3", "f1_sd1", "f1_sd2", "f1_sd3", "primero","f3_sd1", "f3_sd2","documento", "f3_sd3", "e04_sd1", "e04_sd2", "e04_sd3", "e04_sd4","_e", "f1_sd1", "f1_sd2", "f1_sd3", "f3_sd1", "f3_sd2","documento", "mismo", "f3_sd3", "e04_sd1", "e04_sd2", "e04_sd3", "e04_sd4","ser", "estar", "tener", "hacer", "decir", "ir", "ver", "dar", "saber", "querer", "llegar",
        "f3_sd3", "e04_sd1", "e04_sd2", "e04_sd3", "e04_sd4","sd1", "sd2", "sd3", "sd4", "sd5", "sd6", "e04_sd1", "e04_sd2", "e04_sd3", "f","_e04_sd1", "_e04_sd2", "_e04_sd3", "_e04_sd4", "sus","ya", "puede", "pueden", "debe", "deben","ser", "estar", "tener", "hacer", "decir", "ir", "ver", "dar", "saber", "querer", "llegar",
        "e04_sd6", "siento", "solo", "está", "eso", "debe","esto", "si","citas", "cita", "código", "códigos", "categoría", "categorías","directamente", "indirectamente", "además", "sin embargo", "aunque", "por lo tanto", "en consecuencia", "así que","e","f1", "f2", "f3", "e1", "e2", "e3", "e4","ser", "estar", "tener", "hacer", "decir", "ir", "ver", "dar", "saber", "querer", "llegar",
